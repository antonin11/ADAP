...
public class main {
	...
	/*
	 * Ici nous crŽons tous les attributs dont on va avoir besoin dans la classe
	 * main
	 */
	...
	public static void main(String[] args) throws InterruptedException {
		...
		while (true) {
			/*
			 * CrŽation d'une boucle infini dans lequel nous allons entrons les commandes liŽes aux diffŽrentes mŽthode 
			 */
			if (isFinished()) {
				return;
			} else {
